...
function handleAssignButtonClick(assignButton, abilityInput) {
  // Your implementation here
}

function handleInputChange(assignButton, abilityInput) {
  // Your implementation here
}

module.exports = { handleAssignButtonClick, handleInputChange };
